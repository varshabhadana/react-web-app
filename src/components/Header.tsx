      ...
      {id ? (
        <div className="flex gap-4">
          ...
          <button
            ...
            type="button"
            className="inline-block px-8 py-2 border-2 border-[#84a59d] text-blue-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out h-[40px]"
